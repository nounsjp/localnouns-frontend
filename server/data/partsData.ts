...
日本には、明治時代にヨーロッパから伝わり、その後、温室による栽培が開始されています。`},
    { type: `Accessories`, prefecture: `Hokkaido`, key: `hokkaido-sheep`, language: `ja`, name: `羊`, description: `ヒツジは、ウシ科ヤギ亜科の鯨偶蹄目である。角を持ち、主に羊毛のために家畜化されている。` },
    { type: `Accessories`, prefecture: `Aomori`, key: `aomori-jade`, language: `ja`, name: `翡翠`, description: `ヒスイは、深緑の半透明な宝石の一つ。東洋や中南米では古くから人気が高い宝石であり、金以上に珍重された。` },
    { type: `Accessories`, prefecture: `Aomori`, key: `aomori-squid`, language: `ja`, name: `イカ`, description: `全国の港で、常にベスト10に入る水揚げを上げている青森県八戸港。特にイカについては、長きに渡って「イカの水揚げ日本一」を誇っています。コリコリした食感は最高。` },
    { type: `Accessories`, prefecture: `Aomori`, key: `aomori-tsugaru-shamisen`, language: `ja`, name: `津軽三味線`, description: `津軽地方（現在の青森県西部）で成立した三味線音楽。本来は津軽地方の民謡伴奏に用いられるが、現代においては特に独奏を指して「津軽三味線」と呼ぶ場合が多い。撥を叩きつけるように弾く打楽器的奏法と、テンポが速く音数が多い楽曲に特徴がある。` },
    {
...
黄味餡を薄いカステラ生地で包んで焼き上げ、全体をホワイトチョコでコーティングした卵型の菓子である。`},
    { type: `Accessories`, prefecture: `Iwate`, key: `iwate-fujiwara`, language: `ja`, name: `奥州藤原氏`, description: `奥州藤原氏は、前九年合戦・後三年合戦の後の1087年から源頼朝に滅ぼされる1189年までの間に陸奥（後の陸中国）平泉を中心として出羽を含む奥羽地方(現在の東北地方)一帯に勢力を張った藤原北家の支流の豪族。` },
    { type: `Accessories`, prefecture: `Miyagi`, key: `miyagi-beeftongue`, language: `ja`, name: `牛タン`, description: `宮城県の牛タン消費量は日本一！年間なんと５千トンもの牛タンが食べられています。まさに仙台のソウルフードともいえる仙台牛タン。` },
    { type: `Accessories`, prefecture: `Miyagi`, key: `miyagi-matsushima`, language: `ja`, name: `松島`, description: `松島とは、松島湾に浮かぶ260余りの島々と、沿岸部も含めた辺り一帯のことをさしています。または、湾周囲を囲む松島丘陵も含めた修景地区のことである。日本三景の一つに数えられている。2019年の観光入込客数は約598万人。かつては「東の松島 西の象潟」と謳われ、同じく東北地方に存在していた修景地の象潟と並び称されていた。` },
    { type: `Accessories`, prefecture: `Miyagi`, key: `miyagi-zunda`, language: `ja`, name: `ずんだ餅`, description: `ずんだ餅は、すりつぶした枝豆を餡に用いる餅菓子で、宮城県を中心にした地域の郷土菓子。` },
    { type: `Accessories`, prefecture: `Akita`, key: `akita-fireworks`, language: `ja`, name: `花火`, description: `秋田では年に一度、全国の花火師（はなびし）たちが一同に介し、その腕を競い合います。爆発物を使って空中で美しい花や色彩を咲かせるための娯楽や祝祭の一環として使用される、花や光のディスプレイです。花火は通常、特別なイベントや祝祭、お祭り、祝日などで打ち上げられ、観客に楽しみや感動を提供します。花火は多彩な形状や色彩を持ち、美しい芸術的な演出が可能です。また、安全に扱うことが重要であり、専門家によって操作されることが一般的です。` },
    { type: `Accessories`, prefecture: `Akita`, key: `akita-hatahata`, language: `ja`, name: `ハタハタ`, description: `秋田のハタハタは、日本の秋田県で特に有名な魚の一種です。ハタハタはサケ科に属し、日本海に生息しています。秋田県では、ハタハタは冬季に特に豊富に獲れることで知られており、冬の味覚として親しまれています。` },
    ...
    { type: `Accessories`, prefecture: `Yamagata`, key: `yamagata-cherry`, language: `ja`, name: `さくらんぼ`, description: `山形県のさくらんぼは生産量が全国第1位で、全国の生産量の約75％を占める山形県を代表する果物です。山形県は、夏は暑く梅雨のときも雨が少なく、風も強くないなど、さくらんぼが育つのに適した気候であることから、山形県内で多く栽培されるようになったといわれています。` },
    { type: `Accessories`, prefecture: `Yamagata`, key: `yamagata-lafrance`, language: `ja`, name: `やまがたの女王「ラ・フランス」`, description: `山形県は、西洋なしの生産量が全国1位で全国の生産量の6割以上を占めています（令和2年）。特に、西洋なしの品種「ラ・フランス」は緻密な果肉、果汁の多さ、特有の芳香、そしておいしさから「果物の女王」と称されています。` },
    {
...
その歴史は江戸時代後期にまで遡ります。`},
    { type: `Accessories`, prefecture: `Fukushima`, key: `fukushima-akabeko`, language: `ja`, name: `赤べこ`, description: `赤べこは、赤い牛に似せた張子である。会津地方の郷土玩具であり、子どもの魔避けとして用いられてきた。` },
    {
...
猪苗代湖は「会津若松市、郡山市、猪苗代町」の二市一町にまたがる湖です。`},
    { type: `Accessories`, prefecture: `Fukushima`, key: `fukushima-train`, language: `ja`, name: `とある電車`, description: `飯坂線は、福島県福島市の福島駅から飯坂温泉駅に至る福島交通の鉄道路線である。 「飯坂電車」「いい電」の愛称がある。` },
    { type: `Accessories`, prefecture: `Ibaraki`, key: `ibaraki-bellpepper`, language: `ja`, name: `ピーマン`, description: `茨城県のピーマンは出荷量が日本一。全国のうち、ほぼ4分の1を誇ります。なかでも、神栖市は太平洋と利根川に挟まれ、温暖な気候と砂丘地帯で水はけの良い土壌に恵まれたピーマンの大産地です。` },
    {
...
今日の主流である小粒大豆を使用したのが特徴である。`},
    { type: `Accessories`, prefecture: `Ibaraki`, key: `ibaraki-rokkakudo`, language: `ja`, name: `六角堂`, description: `六角堂は、茨城県北茨城市にある六角形の建築物。「関東の松島」の異名を持つ景勝地・五浦海岸の中でも優れた景観を示すところに建つ。` },
    { type: `Accessories`, prefecture: `Tochigi`, key: `tochigi-gyoza`, language: `ja`, name: `餃子`, description: `餃子の街として有名な宇都宮市。宇都宮市民の餃子好きの理由は、冬寒く夏暑い内陸性の気候に対応するためスタミナのある餃子を食べるのだとも、昔宇都宮に駐屯していた第14師団が中国東北部に進出した際に食べていたのを帰国後広めたともいわれます。` },
    {
...
レモン果汁は入っておらず、無果汁と表示されている。`},
    { type: `Accessories`, prefecture: `Tochigi`, key: `tochigi-shimotsukare`, language: `ja`, name: `しもつかれ`, description: `栃木県を代表する郷土料理のひとつ。正月に食べた塩引き鮭の頭や、節分に煎った福豆の残りの大豆などの残り物を使った、先人たちの知恵が詰まった一品である。` },
    { type: `Accessories`, prefecture: `Gunma`, key: `gunma-akagiyama`, language: `ja`, name: `赤城山`, description: `赤城山は、関東地方の北部、群馬県のほぼ中央に位置する山。` },
    { type: `Accessories`, prefecture: `Gunma`, key: `gunma-tomiokasilkmill`, language: `ja`, name: `富岡製糸場`, description: `富岡製糸場は、群馬県富岡市に設立された日本初の本格的な機械製糸の工場である。敷地を含む全体が国の史跡に、初期の建造物群が国宝および重要文化財に指定されている。` },
    {
...
うるち米が原料のせんべい。硬めでぱりっとした食感が人気である。`},
    { type: `Accessories`, prefecture: `Chiba`, key: `chiba-inubosaki`, language: `ja`, name: `犬吠埼`, description: `犬吠埼（いぬぼうさき）は、日本の千葉県にある地名です。犬吠埼は、千葉半島の先端に位置し、太平洋に突き出ている地域で知られています。この地域は美しい海岸線や灯台があり、観光スポットとしても人気です。特に、犬吠埼灯台は有名で、その景色は訪れる人々に楽しまれています。また、周辺には海水浴や海の幸を楽しむための施設もあり、自然愛好家や観光客にとって魅力的な場所となっています。` },
    { type: `Accessories`, prefecture: `Chiba`, key: `chiba-orca`, language: `ja`, name: `シャチ`, description: `千葉県がシャチで有名なのは、千葉市にある「鴨川シーワールド」がシャチの飼育とショーを行っているためです。鴨川シーワールドは日本国内で最も有名な水族館の一つであり、シャチショーが人気を集めています。そのため、千葉県はシャチの観察やショーを楽しむ観光地として知られています。` },
    { type: `Accessories`, prefecture: `Chiba`, key: `chiba-peanuts`, language: `ja`, name: `落花生`, description: `落花生（らっかせい）は、アーモンドやピスタチオのような種実類の一種で、主に地下で成長する植物です。英語では 'peanut' とも呼ばれます。落花生は地中に花を咲かせ、その後地下に果実を形成します。この果実は通常、豆のような形をしており、中には食べられる実が含まれています。` },
    {
...
2020年現在は、東京スカイツリーに次ぐ日本で2番目に高い建造物である。'`},
    { type: `Accessories`, prefecture: `Tokyo`, key: `tokyo-yamanote`, language: `ja`, name: `山手線`, description: `山手線は、日本の首都である東京の都心部で環状運転を行い、多くの駅において、都心から各方面へと伸びるJR東日本や私鉄各社の放射路線および都心部を走る地下鉄各線に接続している。` },
    {
        type: `Accessories`, prefecture: `Kanagawa`, key: `ibaraki-natto`, language: `ja`, name: `納豆`, description: `全国で販売されている納豆の半分以上が茨城県産である。
今日の主流である小粒大豆を使用したのが特徴である。`},
    { type: `Accessories`, prefecture: `Kanagawa`, key: `kanagawa-baybridge`, language: `ja`, name: `横浜ベイブリッジ`, description: `横浜ベイブリッジは、1989年に開通した神奈川県横浜市にある長さ860 mの斜張橋である。東京港方面と横浜港を結ぶ港湾物流の一端を担うことにより、都市部の渋滞を緩和する重要な輸送路である。` },
    {
...
新潟市のさやまめ購入量も日本一。
新潟は枝豆王国なんです。`},
    { type: `Accessories`, prefecture: `Niigata`, key: `niigata-riceear`, language: `ja`, name: `稲穂`, description: `米の生産量日本一の米どころ新潟県。なかでも魚沼地域で生産される魚沼コシヒカリは、全国的に名高いブランド米だ。` },
    { type: `Accessories`, prefecture: `Toyama`, key: `toyama-kutabe`, language: `ja`, name: `クタべ`, description: `顔が人で体が獣の疫病流行の予言を告げる予言獣です。 言い伝えによると、立山に薬種(薬となる原料)を掘りに来た者に「4、5年の内に原因不明の難病が流行するが、我が姿を見た者はその難を逃れられる。」と告げたといいます。 ` },
    {
...
「富山県のさかな」として、ブリ、ホタルイカと並んで指定されている。`},
    { type: `Accessories`, prefecture: `Toyama`, key: `toyama-tateyama`, language: `ja`, name: `立山`, description: `立山は、日本の富山県、飛騨山脈（北アルプス）北部の中部山岳国立公園内にある日本を代表する山。立山信仰の山号として知られている。` },
    {
...
加賀五彩とは、臙脂・藍・黄土・草・古代紫の五色で構成された、主に加賀友禅で用いられる色です。`},
    { type: `Accessories`, prefecture: `Ishikawa`, key: `ishikawa-oyster`, language: `ja`, name: `能登牡蠣`, description: `石川県では能登が牡蠣の産地で有名です。能登は日本海に突き出した半島で、荒々しい波しぶきの日本海側は外浦、冬でも比較的穏やかな穴水湾・七尾湾側を内浦と呼びます。そんな穏やかな穴水湾や七尾湾には、牡蠣の餌になるプランクトンが多く牡蠣の養殖がさかんに行われているのです。` },
    ...
    { type: `Accessories`, prefecture: `Fukui`, key: `fukui-heshiko`, language: `ja`, name: `ヘシコ`, description: `へしことは、青魚に塩を振って塩漬けにし、さらに糠漬けにした郷土料理。若狭地方（福井県南部）および京都府丹後半島の伝統料理で、越冬の保存食として重宝されている。` },
    { type: `Accessories`, prefecture: `Fukui`, key: `fukui-yokan`, language: `ja`, name: `水ようかん`, description: `福井県の冬の食の代表格といえば水ようかん。全国的には夏に食べる涼菓子として知られていますが、福井県では雪が降る寒い時期に、こたつに入って食べるのが一般的。福井県民特有の食文化。` },
    { type: `Accessories`, prefecture: `Yamanashi`, key: `yamanashi-fuji`, language: `ja`, name: `富士山`, description: `日本一の高さを誇る富士山は高さ3776m、地元では3776の車のナンバーが抽選になるほど人気です。` },
    {
...
水はけの良い扇状地や長い日照時間、昼夜の寒暖差などの環境条件が整う山梨県は、まさにぶどうにとって最適の生育地。`},
    { type: `Accessories`, prefecture: `Nagano`, key: `nagano-kappa`, language: `ja`, name: `河童`, description: `河童は、日本の水の妖怪。水神、またはその依り代、またはその仮の姿ともいう。鬼、天狗と並んで日本の妖怪の中で最も有名なものの一つとされる。` },
    { type: `Accessories`, prefecture: `Nagano`, key: `nagano-oyaki`, language: `ja`, name: `おやき`, description: `長野県の郷土料理。土地ごとに特色があり、野沢菜などの具材を水に溶いた小麦粉、そば粉などの皮で包みます。おやきの調理法は焼き、蒸しや、蒸した後に焼く場合もあります。` },
    { type: `Accessories`, prefecture: `Gifu`, key: `gifu-gero`, language: `ja`, name: `下呂温泉`, description: `歴史は古く、江戸時代より湯治場として栄えてきた下呂温泉は草津、有馬と並ぶ日本三名泉のひとつ。泉質はアルカリ性単純泉。肌になめらかな独特の感じがある下呂の湯を楽しみに、年間多くの人が訪れている。白川郷より移築した合掌造りが点在する「下呂温泉合掌村」。春～秋には、「いでゆ朝市」も開催されている。` },
    { type: `Accessories`, prefecture: `Gifu`, key: `gifu-gohei-mochi`, language: `ja`, name: `五平餅`, description: `五平餅は、岐阜県に伝わる郷土料理。粒が残る程度に半搗きにした粳米（うるちまい）飯にタレをつけ、串焼きにしたものである。` },
    {
...
飛騨弁では、赤ちゃんのことを「ぼぼ」と言い、「さるぼぼ」は「猿の赤ん坊」の意味。近年では、土産として飛騨地方の観光地で多く見られる。`},
    { type: `Accessories`, prefecture: `Gifu`, key: `gifu-ukaibody`, language: `ja`, name: `鵜飼い`, description: `鵜飼いは、飼いならした鵜を使ってアユなどを獲る伝統的な漁法。日本では平安時代から貴族や武士などが鵜飼見物を行ってきた歴史があり、現代でも各地で観光としての鵜飼が行われている。特に岐阜県岐阜市の長良川鵜飼が有名である。` },
    { type: `Accessories`, prefecture: `Shizuoka`, key: `shizuoka-fuji`, language: `ja`, name: `富士山`, description: `日本一の高さを誇る富士山は高さ3776m、地元では3776の車のナンバーが抽選になるほど人気です。` },
    { type: `Accessories`, prefecture: `Aichi`, key: `aichi-misodengaku`, language: `ja`, name: `味噌田楽`, description: `味噌田楽は、豆腐、あるいは里芋、茄子、こんにゃくなどを串に刺して焼き、砂糖や味醂を配合し柚子や木の芽などで香りをつけた味噌を塗りつけた料理である。` },
    { type: `Accessories`, prefecture: `Aichi`, key: `aichi-oguratoast`, language: `ja`, name: `小倉トースト`, description: `小倉トーストとは、愛知県の喫茶店で供されている軽食の一種。厚めにスライスした食パンをトーストした後に、マーガリンまたはバターを塗って小倉餡を乗せたもの。` },
    {
...
そして、その調理法は、一皿のアート。刺身でのピュアな甘み、姿焼きの力強さ、蒸し伊勢海老の繊細さ、そして味噌汁の深み。伊勢海老は、四季を越え、四年の時を経て、我々の前に極上の一皿として姿を現します。`},
    { type: `Accessories`, prefecture: `Mie`, key: `mie-mochi`, language: `ja`, name: `餅`, description: `三重の旅路、餅の風味！' 伊勢神宮への古道を歩むと、時を超えた餅の物語が始まります。三重の土地は、餅米を育むのにぴったり。だからこそ、伊勢から桑名の「餅街道」には、旅人の胃袋と心をつかむ餅屋が立ち並ぶ。そして、その星の中でも輝くのが「赤福」。古びた建物の中で、五十鈴川の清流を模した伝統の赤福餅を守り続けています。名前の「赤福」は「赤心慶福」から。心を込めた餅づくりの情熱が、今も変わらず続いているのです。参宮客の増加や地域の祭りの需要、そして三重の恵まれた自然環境が、この餅文化の発展を後押し。一口食べれば、三重の餅の深い歴史と情熱を感じられること間違いなし！` },
    {
...
神戸のランドマークとして、多くの人々に愛されてるんやけど、ちょっと今、2021年9月27日から美容整形（耐震化などの補強工事）のためお休み中。でも、2024年春には、もっとキレイになって帰ってくる予定やで！`},
    { type: `Accessories`, prefecture: `Nara`, key: `nara-kakinohasushi`, language: `ja`, name: `柿の葉寿司`, description: `柿の葉寿司、これが奈良のごちそうやねん！サバと酢飯、柿の葉でくるんであるんやけど、どこから来たのかはちょっと謎やわ。昔の夏祭りや、戦の時の食べ物としても使われてたってんな。あの鮮やかな柿の葉、防腐効果もあって、サバのうまさが引き立つんや。五條や吉野では、夏祭りや大事な日には外せんねん。食べ方は、冷えすぎたらレンジであっためて、冬は焼いてもええねん。今でも奈良のおみやげとしてめっちゃ人気！奈良に来たら、この伝統のうまさ、味わわんともったいないで！` },
    { type: `Accessories`, prefecture: `Nara`, key: `nara-narazuke`, language: `ja`, name: `奈良漬`, description: `奈良漬け、これが奈良の伝統的な味の秘密やで！酒粕に複数回漬けることで、美しい「べっこう色」に変わるんや。主に白うりやきゅうり、生姜、なすなどを使うけど、製造業者によっては、たくさんの野菜や果物が使われることもあるんやで。奈良時代からの歴史があって、甘さや塩気、独特の風味が楽しめるんや。ちなみに、3.5％以上のアルコール分も含んでるから、ちょっと大人の味やね。奈良に来たら、この伝統の味をぜひ体験してみてな！` },
    {
...
岡山、日本の「果物王国」。ここでは、130年以上の歴史を持つマスカット・オブ・アレキサンドリアをはじめ、ニューピオーネのワインレッドの美しさ、シャインマスカットの皮ごとの食感、オーロラブラックの甘さ、そして冬の紫苑の色鮮やかさといった多彩なブドウが栽培されています。岡山の北部の気候は、昼夜の寒暖差が大きく、ブドウの甘さや色づきを引き出します。これらのブドウは、岡山県の推奨品種として、その品質と多様性で知られています。岡山のブドウは、太陽の恵みを受けて、一粒一粒が贅沢な味わいを持っています。`},
    ...
    { type: `Accessories`, prefecture: `Okayama`, key: `okayama-denim-jacket02`, language: `ja`, name: `デニムジャケット`, description: `②藍染めの技術と伝統: 岡山は、伝統的な藍染め技術が受け継がれてきた地域で、この染色技術はデニムに深い色合いと独特の風合いをもたらします。特に「芯白」という染色技術は、海外でも高く評価されています。` },
    { type: `Accessories`, prefecture: `Okayama`, key: `okayama-denim-jacket03`, language: `ja`, name: `デニムジャケット`, description: `③シャトル織機と技術の革新: セルヴィッチデニムはシャトル織機でしか織れない特別なデニムで、存在感や雰囲気に圧倒的な違いがあります。岡山デニムは伝統的な製法を守りつつ、新しい技術やアイディアを取り入れています。` },
    {
...
桃太郎、日本の語り継がれる英雄。桃から誕生し、仲間たちと共に鬼を退治するこの物語は、岡山の吉備地方に実際に存在したとされる伝承と深く結びついています。吉備の古代神話と桃太郎のエピソードは驚くほど一致し、岡山駅前の桃太郎像はその繋がりを物語っています。しかし、桃太郎の伝説は日本全国に広がり、各地で異なるバージョンが語られてきました。古代の他国の物語との共通点も指摘され、桃太郎は国際的な英雄とも言えるでしょう。岡山と桃太郎の繋がりは、キビ団子や桃の特産品とも深く関係しており、古代の歴史と物語が融合した岡山の桃太郎は、今も私たちの心に生き続けています。`},
    { type: `Accessories`, prefecture: `Okayama`, key: `okayama-peach02`, language: `ja`, name: `白桃`, description: `瀬戸内の温暖な気候に恵まれて収穫される岡山の白桃は、甘みたっぷりでなめらかな味、気品ある香り、上品な姿が特徴で、全国にその名を馳せています。` },
    { type: `Accessories`, prefecture: `Okayama`, key: `okayama-retainer`, language: `ja`, name: `家来`, description: `お腰につけたきび団子、一つ私にくださいな。` },
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-battleship`, language: `ja`, name: `大和(戦艦)`, description: `大和は、大日本帝国海軍が建造した大和型戦艦の1番艦。2番艦の武蔵とともに、史上最大にして唯一46センチ砲を搭載した超弩級戦艦である。建造当初は、世界最大の戦艦だった。` },
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-lemon`, language: `ja`, name: `広島レモン`, description: `広島レモンは、広島県で生産されているレモン。減農薬あるいは無農薬で栽培され防腐剤やワックスは使用していないため、安全に皮ごと食べられる。` },
    {
...
広島牡蠣の特徴は身がプリっとしていて濃厚な味わいが楽しめます。`},
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-rice-scoop`, language: `ja`, name: `しゃもじ`, description: `日露戦争の時代、広島湾に位置する宮島は、軍人たちの出征地の一つとなっていたため、軍人たちは出征前、宮島の厳島神社を訪れ、無事に帰ってくることを祈念し、お守り代わりとして、しゃもじを奉納していたという。` },
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-shrine`, language: `ja`, name: `厳島神社`, description: `広島県廿日市市の厳島（宮島）にある神社。全国に約500社ある厳島神社の総本社である。1996年にユネスコの世界文化遺産に「厳島神社」として登録されている。` },
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-wani`, language: `ja`, name: `ワニ料理`, description: `ワニ料理とは、広島県のうち三次市や庄原市などの備北地域で食べられる郷土料理である。` },
    {
...
日本三名橋や日本三大奇橋に数えられており、名勝に指定されている。`},
    { type: `Accessories`, prefecture: `Yamaguchi`, key: `yamaguchi-motonosumiinari`, language: `ja`, name: `元乃隅稲成神社`, description: `元乃隅稲成神社は、山口県長門市油谷津黄にある神社。` },
    { type: `Accessories`, prefecture: `Yamaguchi`, key: `yamaguchi-white -snake`, language: `ja`, name: `岩国の白蛇`, description: `岩国のシロヘビは、山口県岩国市に生息する白蛇である。この白蛇は遺伝によって白化が子孫の代にも受け継がれている。日本国指定の天然記念物。` },
    { type: `Accessories`, prefecture: `Yamaguchi`, key: `yamaguhchi-tsunoshima-big-bridge`, language: `ja`, name: `角島大橋`, description: `角島大橋は、山口県下関市豊北町神田と同市豊北町角島間の海士ヶ瀬戸に架かる橋。全長1780メートル。` },
    { type: `Accessories`, prefecture: `Tokushima`, key: `tokushima-awaodori`, language: `ja`, name: `阿波踊り`, description: `阿波国（現・徳島県）を発祥とする盆踊り。高知のよさこい祭りと愛媛の新居浜太鼓祭りと並ぶ四国三大祭りであり、日本三大盆踊りの一つとしても知られる。` },
    { type: `Accessories`, prefecture: `Tokushima`, key: `tokushima-citrus-sudachi`, language: `ja`, name: `すだち`, description: `すだちは、徳島県を代表する香酸柑橘類で、すがすがしい香りと、さわやかな酸味が特徴です。国内生産の９割以上が徳島県であり、生産量は全国１位を誇ります。` },
    { type: `Accessories`, prefecture: `Tokushima`, key: `tokushima-narutomaki`, language: `ja`, name: `鳴門巻き`, description: `鳴門巻きは、魚肉のすり身を主原料とする断面が渦巻模様の蒲鉾の一種。白色と、食用色素で赤く着色した二色のすり身を用いて作られた細長い円筒形の魚肉練り製品である。` },
    {
...
今日では、色の違う団子（上から抹茶・卵・小豆）を3個串刺しにしたものが「坊っちゃん団子」としては最もポピュラーな商品となっている。`},
    { type: `Accessories`, prefecture: `Ehime`, key: `ehime-juice`, language: `ja`, name: `みかんジュース`, description: `日本有数のみかんの産地として知られる愛媛県。そんなみかん王国の愛媛県には「蛇口をひねるとみかんジュースが出てくる」という有名な都市伝説がありますが、実は本当にみかんジュースが出てくる蛇口が数カ所存在するのです。` },
    { type: `Accessories`, prefecture: `Ehime`, key: `ehime-mandarin-orange`, language: `ja`, name: `カメマンダリン`, description: `カラマンダリンは、いろいろな柑橘の中でも木になっている期間が最も長い品種です。そのため果汁がとにかく濃厚でみかんの果汁が濃縮されているような味わいです。` },
    {
...
「爪」とも呼ばれる殻板を持って、「皮」とも呼ばれる柄部を外して抜き出した中身が食用となる。濃厚な旨味を持つ。愛媛県宇和島市ではよく食され、塩茹でや味噌汁の具などにする。`},
    { type: `Accessories`, prefecture: `Kochi`, key: `kochi-seared-bonito`, language: `ja`, name: `カツオのたたき`, description: `鰹のタタキは刺身の一種で、高知県発のカツオを用いた料理。鰹を節に切り、表面のみをあぶったのち冷やして切り、薬味とタレをかけて食べるもので、別名「土佐造り」とも言う。` },
    { type: `Accessories`, prefecture: `Fukuoka`, key: `fukuoka-mentaiko`, language: `ja`, name: `明太子`, description: `明太子（めんたいこ）は、スケトウダラの卵巣（たらこ）を塩漬け熟成し、塩抜き後に唐辛子・昆布・砂糖・醤油などの調味液に漬け込んで発酵させた惣菜である。釜山の「唐辛子をまぶした塩漬けタラコ」である「明卵漬」が由来であり、ふくや（福岡の会社）の川原俊夫が日本人向けに製造法を変更し、砂糖を加えるなど味付けの塩辛さを減らして生み出された。ふくやが製造法を独占せずに他企業へ教えたことから日本全国へ普及した` },
    { type: `Accessories`, prefecture: `Fukuoka`, key: `fukuoka-umegaeda`, language: `ja`, name: `梅ヶ枝餅`, description: `小豆餡を薄い餅の生地でくるみ、梅の刻印が入った鉄板で焼く焼餅である。出来上がると中心に軽く梅の刻印が入るようになっている。その名称は太宰府天満宮の祭神である菅原道真の逸話に由来しており、梅の味や香りがする訳ではない。` },
    { type: `Accessories`, prefecture: `Saga`, key: `saga-saga`, language: `ja`, name: `SAGA（佐賀）`, description: `『SAGA』は佐賀県出身のお笑い芸人”はなわ”が作詞作曲したご当地ソングのサビフレーズ。` },
    { type: `Accessories`, prefecture: `Saga`, key: `saga-yobuko-squid`, language: `ja`, name: `呼子のイカ`, description: `呼子（よぶこ）は、日本の佐賀県に位置する漁村で、特にその新鮮で美味しいイカで知られています。呼子のイカは地元漁師たちが獲る海の宝物で、その味わいは絶品です。呼子のイカは新鮮で柔らかく、甘みと旨みが豊かで、刺身や寿司、焼きイカ、イカめしなど、さまざまな料理に利用されます。漁港では毎日、新鮮なイカが水揚げされ、地元の市場やレストランで提供されています。` },
    { type: `Accessories`, prefecture: `Nagasaki`, key: `nagasaki-castella`, language: `ja`, name: `カステラ`, description: `カステラは、鶏卵を泡立てて小麦粉・水飴を混ぜ合わせた生地をオーブンで焼いた菓子の一つ。ポルトガルから伝わった南蛮菓子を元に日本で独自に発展した和菓子である。ポルトガルには「カステラ」という名の菓子はなく、原型とされる菓子もカステラとは見た目も製法も異なる。日本におけるカステラは長崎県が本場とされている。` },
    {
...
大分県では、古くから畑を基盤とした穀物栽培が営まれており、小麦粉を使った粉食文化が発展した。「やせうま」のほかにも、小麦粉を使った料理は県内各地に浸透している。`},
    { type: `Accessories`, prefecture: `Miyazaki`, key: `miyazaki-mango`, language: `ja`, name: `マンゴー`, description: `宮崎県のマンゴーは、日本国内外で高い評価を受けており、日本国内でのブランド価値が非常に高い果物として知られています。宮崎県は、マンゴーの生産技術と品質管理において高い水準を維持し、新しい品種の開発や農業技術の向上にも取り組んでいます。宮崎マンゴーは、夏季に食べる美味しい贅沢なフルーツとして、多くの人々に愛されています。` },
    { type: `Accessories`, prefecture: `Miyazaki`, key: `miyazaki-takachihokyo`, language: `ja`, name: `高千穂峡`, description: `高千穂峡は、宮崎県に広がる美しい渓谷で、自然愛好家や文化探求家に魅力的な場所です。急峻な峡谷の壁と清流が特徴で、四季折々の景色が楽しめ、特に秋の紅葉や春の新緑が魅力的です。菊池大滝という滝は神話に登場し、神秘的な雰囲気を持っています。` },
    { type: `Accessories`, prefecture: `Kagoshima`, key: `kagoshima-senganen`, language: `ja`, name: `仙巌園`, description: `仙巌園は、鹿児島県鹿児島市にある薩摩藩主島津氏の別邸・大名庭園。別名は磯庭園。島津氏第19代当主・島津光久によって磯に別邸として建設された。錦江湾を隔てて桜島を借景とする庭園となっており、国の名勝に指定されている。` },
    { type: `Accessories`, prefecture: `Kagoshima`, key: `kagoshima-shochu`, language: `ja`, name: `焼酎`, description: `焼酎は鹿児島県で生産される伝統的なお酒です。鹿児島の温暖な気候と豊かな自然環境が、この焼酎の独特の風味に影響を与えています。麦、芋、さつまいもなど、さまざまな原料を使用して醸造され、独自の製法で蒸留されます。鹿児島焼酎は、そのまろやかで芳醇な味わいと、多彩な飲み方のバリエーションで知られています。ロック、お湯割り、お茶割り、果物割りなど、さまざまなスタイルで楽しむことができ、日本国内外で高く評価されています。` },
    { type: `Accessories`, prefecture: `Okinawa`, key: `okinawa-fish`, language: `ja`, name: `南国の魚`, description: `沖縄の美しい海には、カラフルな魚たちが広がる壮観なサンゴ礁があります。この地域はスクーバダイビングやシュノーケリングの楽園として知られ、その魚たちの美しさはまさに絶景です。` },
    { type: `Accessories`, prefecture: `Okinawa`, key: `okinawa-satokibi`, language: `ja`, name: `サトウキビ`, description: `サトウキビは砂糖の材料の一つです。サトウキビは、強風や水不足に対して大変強い作物です。このため、台風や干ばつなどの厳しい自然環境にある沖縄県においては欠かすことのできない基幹作物であり、農家の約7割の方々がサトウキビを栽培しています。` },
    {
...
沖縄では豆腐の上にのせて食べるのが一般的。ミネラルたっぷりの天然塩にじっくりと漬け込んだ独特の塩辛が美味しいおつまみですよ！`},
    { type: `Heads`, prefecture: `Hokkaido`, key: `head-01-hokkaido`, language: `ja`, name: `北海道`, description: `北海道は、日本の北海道地方に位置する道。道庁所在地は札幌市で、47都道府県中唯一の「道」である。` },
    { type: `Heads`, prefecture: `Hokkaido`, key: `hokkaido-goryokaku`, language: `ja`, name: `五稜郭`, description: `五稜郭は、江戸時代末期に江戸幕府が蝦夷地の箱館（現在の北海道函館市）郊外に築造した稜堡式の城郭である。` },
    {
...
三角屋根の上に大時計を載せた特徴的な外観の建築物であり、時計台としては日本最古である。`},
    { type: `Heads`, prefecture: `Aomori`, key: `aomori-apple`, language: `ja`, name: `りんご`, description: `青森県では、津軽地方に世界でも有数の生産団地が形成されており、現在、全国のりんご生産量の約60％を占める日本一のりんご王国となっています。青森県におけるりんご産業は、経済上のみならず、文化・観光面においても重要な役割を果たしています。` },
    { type: `Heads`, prefecture: `Aomori`, key: `aomori-dogu`, language: `ja`, name: `土偶`, description: `土偶は、縄文時代頃の日本列島で作られていた土人形を指す。` },
    { type: `Heads`, prefecture: `Aomori`, key: `aomori-goldfish-nebuta`, language: `ja`, name: `金魚ねぶた`, description: `青森の金魚ねぶたは、造花店（葬儀屋）が内職で作り始めたとされ、全体として丸みをおび、鱗が荒く、目の間隔が開いているので剽軽（ひょうきん）な顔であり、背びれは無い等々の特徴がある。` },
    {
...
面積は日本の都道府県としては、北海道に次いで2番目に広い。県の人口およそ120万人のうち、100万人以上（8割強）は内陸部の北上盆地に集中し、沿岸部は平地が少なく小都市が点在する。`},
    { type: `Heads`, prefecture: `Iwate`, key: `iwate-moriokamen`, language: `ja`, name: `盛岡三大麺`, description: `盛岡三大麺とは、盛岡冷麺、盛岡じゃじゃ麺、わんこそばの総称である。 ` },
    { type: `Heads`, prefecture: `Iwate`, key: `iwate-nanbutekki`, language: `ja`, name: `南部鉄器`, description: `南部鉄器は、岩手県南部鉄器協同組合連合会の加盟業者によって作られている鉄器。74の事業所に730名（推計）の従事者がおり、年間生産額は約92億円。` },
    {
...
県内の平野部では稲作が盛んであり、ササニシキやひとめぼれの産地である。`},
    { type: `Heads`, prefecture: `Miyagi`, key: `miyagi-datemasamune`, language: `ja`, name: `伊達政宗`, description: `伊達 政宗は、山形県と宮城県の武将・戦国大名。伊達氏の第17代当主。近世大名としては、仙台藩の初代藩主である。` },
    { type: `Heads`, prefecture: `Miyagi`, key: `miyagi-hoya`, language: `ja`, name: `ほや`, description: `宮城県におけるほやの生産量は全国第1位で、全国の約8割を占めています。ほやの大部分は養殖されたもので、ほやの養殖は宮城県で明治時代に始まったとされています。` },
    { type: `Heads`, prefecture: `Miyagi`, key: `miyagi-tanabata`, language: `ja`, name: `仙台七夕`, description: `仙台七夕は、旧仙台藩内各地で五節句の1つ「七夕」に因んで毎年行われている年中行事および祭である。地元では「たなばたさん」とも呼ばれている。宮城県仙台市で開催されている仙台七夕まつりが特に著名で東北三大祭りの一つとされている。` },
    { type: `Heads`, prefecture: `Akita`, key: `akita-akitainu`, language: `ja`, name: `秋田犬`, description: `秋田犬は、日本の秋田県がその起源地であることからその名前が付けられました。この犬種は秋田県で発展し、育種されたため、「秋田犬」という名前が付けられました。秋田犬は日本国内外で非常に有名で、その忠実で賢い性格と美しい外観から多くの人々に愛されています。` },
    { type: `Heads`, prefecture: `Akita`, key: `akita-magewappa`, language: `ja`, name: `曲げわっぱ`, description: `秋田県が曲げわっぱで有名な理由は、長い歴史と木材の豊富さが結びついています。秋田の職人たちは代々伝統技術を受け継ぎ、高品質な曲げわっぱを作り出してきました。地元の誇りとして、これらの木製品は観光客にも販売され、秋田県のアイデンティティと文化の一部となっています。` },
    { type: `Heads`, prefecture: `Akita`, key: `akita-namahage`, language: `ja`, name: `ナマハゲ`, description: `ナマハゲは、日本の秋田県などで行われる伝統的な祭りや行事で、人々が鬼のような仮面をつけて子供たちに厳しい教訓を説く役割を果たすキャラクターです。` },
    { type: `Heads`, prefecture: `Akita`, key: `head-05-akita`, language: `ja`, name: `秋田`, description: `秋田には伝統的な祭りや行事が豊富にあり、その中でも「竿燈祭り」や「ナマハゲ」など独自の文化が存続しています。これらの祭りは地元のアイデンティティを反映し、訪れる人々に独特の体験を提供します。` },
    {
...
県の中央には最上川が流れる。県民の多くがこの川の流域に住んでいるため、「母なる川」とも呼ばれている。`},
    { type: `Heads`, prefecture: `Yamagata`, key: `yamagata-hanagasa`, language: `ja`, name: `花笠まつり`, description: `花笠まつりは、スゲ笠に赤い花飾りをつけた花笠を手にし、「花笠音頭」にあわせて街を踊り練りあるく日本の祭である。` },
    { type: `Heads`, prefecture: `Yamagata`, key: `yamagata-imoni`, language: `ja`, name: `芋煮`, description: `「芋煮」は里芋の収穫期の秋から冬によく食べられている郷土料理の一つ。「芋煮会」といって河原に鍋や材料を持込み、家族や友人などと一緒につくったり、運動会や地域行事の後などに野外でつくったりするほか、各家庭でもつくり食べられている。` },
    { type: `Heads`, prefecture: `Yamagata`, key: `yamagata-zaookama`, language: `ja`, name: `蔵王御釜`, description: `宮城県にある火口湖で、五色沼とも呼ばれる。蔵王連峰の中央部の最も標高の高いエリアにあり、しばしば蔵王連峰の象徴として見られている。宮城県と山形県の県境から至近であり、宮城県のみならず山形県の名所としても紹介される。` },
    { type: `Heads`, prefecture: `Fukushima`, key: `fukushima-peach`, language: `ja`, name: `桃`, description: `全国生産の20%を占める桃は“くだもの王国ふくしま”を代表する果物です。旬の時期も長く、6月下旬から9月中旬まで楽しめます。多くの産地が県内の盆地に集中しており、夏の暑さが甘みを凝縮されることで、美味しい桃に育ちます。` },
    { type: `Heads`, prefecture: `Fukushima`, key: `fukushima-takizakura`, language: `ja`, name: `三春滝桜`, description: `三春滝桜は、福島県に所在する推定樹齢1000年超の国の天然記念物の枝垂れ性のサクラの巨木。三春の滝桜、また単に滝桜とも呼ばれる。日本五大桜または三大巨桜の1つとして知られる。` },
    { type: `Heads`, prefecture: `Fukushima`, key: `fukushima-tsurugacastle`, language: `ja`, name: `鶴ヶ城`, description: `若松城は、福島県会津若松市にある城跡である。別名は鶴ヶ城で、地元ではこの名で呼ばれることが多い。また、同名の城が他にあるため、会津若松城とも呼ばれる。若松城跡として国の史跡に指定されている。` },
    {
...
県東部の鹿嶋市・神栖市では鹿島臨海工業地帯を形成し、工業化が進んでいる。`},
    { type: `Heads`, prefecture: `Ibaraki`, key: `ibaraki-anglerfish`, language: `ja`, name: `茨木あんこう`, description: `茨城の冬の味覚を代表する魚となっている、あんこう。「常磐もの」として市場からも高評価です。とくに「茨城あんこう」は県内の底びき網漁師が漁獲した2kg以上の大きさで、漁獲後すぐに鮮度維持の作業を施されて水揚げされたもの。` },
    { type: `Heads`, prefecture: `Ibaraki`, key: `ibaraki-hananuki-ravine`, language: `ja`, name: `花貫渓谷`, description: `花貫渓谷は茨城県高萩市にある花貫ダムの上流に位置する。周囲には、花貫ふるさと自然公園、花貫さくら公園などが整備され、名馬里ヶ淵に代表される渓谷美を楽しめる。カエデやミズナラが多く、新緑、紅葉が美しい。` },
    { type: `Heads`, prefecture: `Ibaraki`, key: `ibaraki-rocket`, language: `ja`, name: `筑波宇宙センター`, description: `筑波宇宙センターは、茨城県つくば市の筑波研究学園都市内にある、宇宙航空研究開発機構（JAXA）が所有する宇宙開発計画関連の独立行政法人施設である。` },
    {
...
県北部に日光国立公園があり、観光地・保養地の日光や那須が知られる。`},
    { type: `Heads`, prefecture: `Tochigi`, key: `tochigi-sanzaru`, language: `ja`, name: `三猿`, description: `三猿とは3匹の猿が両手でそれぞれ目・耳・口を隠している意匠である。「見ざる、聞かざる、言わざる」という叡智の3つの秘密を示している像である。栃木県日光市の神厩舎に施されている。` },
    { type: `Heads`, prefecture: `Tochigi`, key: `tochigi-strawberry`, language: `ja`, name: `苺`, description: `栃木県では、大消費地である首都圏に近い立地と冬場の豊富な日照量を活かし、いちごの生産が盛んに行われています。出荷量は昭和43年から連続日本一で、まさに“いちご王国”です。` },
    { type: `Heads`, prefecture: `Tochigi`, key: `tochigi-toshogu`, language: `ja`, name: `日光東照宮`, description: `日光東照宮は、日本の関東地方北部、栃木県日光市に所在する神社。日本全国の東照宮の総本社的存在である。また久能山東照宮・上野東照宮と共に三大東照宮の一つに数えられる。` },
    {
...
毎分3万2300ℓ以上の自然湧出量は日本一。室町時代には万里集九が有馬温泉や下呂温泉とともに「三名泉」とし、江戸時代には林羅山もこれらの三温泉を「天下の三名泉」と記した。 `},
    { type: `Heads`, prefecture: `Gunma`, key: `gunma-negi`, language: `ja`, name: `下仁田ネギ`, description: `下仁田ネギは、ネギの一種。群馬県甘楽郡下仁田町の冬季の特産品である。江戸時代からすでに栽培が行われており、徳川幕府や大名への献上品とされていた。一本ネギとしては太くて短いずんぐりした姿が特徴で、生だと非常に辛味が強いが、加熱すると甘味が引き出されてやわらかい食感になる。` },
    {
...
首都圏を構成し、都道府県別の人口は東京都、神奈川県、大阪府、愛知県に次ぐ全国第5位。日本で8つある内陸県の一つ。`},
    { type: `Heads`, prefecture: `Saitama`, key: `saitama-tokinokane`, language: `ja`, name: `時の鐘`, description: `埼玉県川越市の中心部、幸町北部の蔵造りの街並みに建てられている鐘楼（時計台）。建物は、川越市指定有形文化財に指定されている。` },
    {
...
白変種による白い虎はホワイトタイガーとして実在する。`},
    { type: `Heads`, prefecture: `Chiba`, key: `chiba-loquat`, language: `ja`, name: `びわ`, description: `最適な環境を提供しています。この特別な組み合わせが、千葉県を日本のびわの楽園に変えています。千葉県のびわは、その糖度の高さと芳醇な風味で知られ、口にするとまるで自然の甘さが溢れ出るかのようです。その魅力は、一度味わったら忘れられないほどです。` },
    {
...
さらに、千葉県は首都圏に近く、ソイソースの供給がスムーズです。これが、多くのレストランや家庭で千葉県産のソイソースが愛用されている理由の一つです。千葉県のソイソースはまさに情熱の結晶であり、その美味しさは一度試す価値があります。ここはソイソース愛好家の聖地と言っても過言ではありません！`},
    { type: `Heads`, prefecture: `Chiba`, key: `head-12-chiba`, language: `ja`, name: `千葉`, description: `千葉（Chiba）は、日本の首都圏に位置する県です。成田国際空港があり、国際的なアクセスが良い地域として知られています。また、東京ディズニーリゾートといった観光名所もあり、国内外から多くの観光客が訪れます。工業地域も発展し、国際的な貿易に貢献しています。千葉県は国際的なつながりが強い地域の一つです。` },
    {
...
2020年現在は、東京スカイツリーに次ぐ日本で2番目に高い建造物である。`},
    { type: `Heads`, prefecture: `Kanagawa`, key: `head-14-kanagawa`, language: `ja`, name: `神奈川県`, description: `日本の関東地方に位置する県。県庁所在地は横浜市。都道府県別の人口では東京都に次ぐ第2位、昼間人口及び人口密度は東京都、大阪府に次ぐ第3位である。` },
    { type: `Heads`, prefecture: `Kanagawa`, key: `ibaraki-anglerfish`, language: `ja`, name: `茨木あんこう`, description: `茨城の冬の味覚を代表する魚となっている、あんこう。「常磐もの」として市場からも高評価です。とくに「茨城あんこう」は県内の底びき網漁師が漁獲した2kg以上の大きさで、漁獲後すぐに鮮度維持の作業を施されて水揚げされたもの。` },
    { type: `Heads`, prefecture: `Kanagawa`, key: `kanagawa-curry`, language: `ja`, name: `金沢カレー`, description: `主に金沢市を中心とする石川県のカレーライス店で供される独自の特徴を持ったカレーライスを言う。` },
    {
...
1955年頃、富山市中心部で富山大空襲の復興事業に従事していた食べ盛りな若者のランチとして、また汗をかく肉体労働者のための塩分補給として、醤油を濃くしたスープのラーメンを作ったのがルーツである。`},
    { type: `Heads`, prefecture: `Toyama`, key: `toyama-kutabe`, language: `ja`, name: `クタべ`, description: `顔が人で体が獣の疫病流行の予言を告げる予言獣です。 言い伝えによると、立山に薬種(薬となる原料)を掘りに来た者に「4、5年の内に原因不明の難病が流行するが、我が姿を見た者はその難を逃れられる。」と告げたといいます。 ` },
    { type: `Heads`, prefecture: `Toyama`, key: `toyama-raicho`, language: `ja`, name: `ライチョウ`, description: `日本アルプスの高山帯にすむ代表的な鳥です。「立山神の使い」といわれ、古くから県民に愛されてきました。特別天然記念物に指定されています。` },
    {
...
都道府県別の年間降水量は5番目に多い。特に冬は北西からの季節風が続くため降水量が多く、山間部は豪雪地帯となっている。降雪時に雷鳴を伴うことが多く、この現象は鰤（ブリ）が獲れる時期と重なることからブリ起こしと呼ばれている。`},
    { type: `Heads`, prefecture: `Ishikawa`, key: `ishikawa-curry`, language: `ja`, name: `金沢カレー`, description: `主に金沢市を中心とする石川県のカレーライス店で供される独自の特徴を持ったカレーライスを言う。` },
    {
...
南に富士山、西に赤石山脈（南アルプス）、北に八ヶ岳、東に奥秩父山地など、標高2,000 m〜3,000mを超す山々に囲まれる。島国の日本において、海に全く面しない数少ない内陸県である。`},
    { type: `Heads`, prefecture: `Yamanashi`, key: `yamanashi-shingen`, language: `ja`, name: `武田信玄`, description: `甲斐（現在の山梨県）の戦国大名です。「甲斐の虎」と呼ばれた彼の率いる武田軍は当時最強と言われ、その武勇はのちの天下人「織田信長」の耳にも届き、恐れさせるほどでした。` },
    {
...
天守は安土桃山時代末期-江戸時代初期に建造された現存天守の一つとして国宝に指定され、城跡は国の史跡に指定されている。天守が国宝指定された5城のうちの一つである。`},
    { type: `Heads`, prefecture: `Nagano`, key: `nagano-wasabi`, language: `ja`, name: `安曇野わさび`, description: `北アルプスの山々に囲まれた長野県安曇野市。名水として知られる雪どけ水が育む特産品が「わさび」です。安曇野で一日に湧き出る水の量は７０万トン。その豊富な湧き水が、野生のわさびにもともとある「成長を妨げる成分」を洗い流し、大きく風味豊かなわさびが育ちます。` },
    {
...
全国有数の工業地域でもあり、ホンダの発祥地でスズキ、ヤマハ発動機の本社がある他、オートバイ、ピアノ、プラモデルの輸出量では日本一を誇る。また、全国一の水揚げ額を有する焼津漁港や、静岡茶が有名である。`},
    { type: `Heads`, prefecture: `Shizuoka`, key: `shizuoka-oden`, language: `ja`, name: `静岡おでん`, description: `牛すじ、黒はんぺん、練り物、大根、卵など具材を全て串に刺し、色の黒いだし汁で煮込み、青のりや魚のだし粉をかけて食べる静岡市の郷土料理。` },
    {
...
蒲焼にしたウナギの身を切り分けた上で、お櫃などに入れたご飯に乗せたものを、食べる側が茶碗などに取り分けて食べるのが基本的なスタイル。一般的にワサビや刻み海苔・刻みネギなどの薬味、出汁やお茶などが添えられて提供され、それらを食べる側の好みに合わせて取り分けた鰻飯にかけたり、お茶漬けにすることにより、味の変化を楽しみながら食べることができる。`},
    { type: `Heads`, prefecture: `Aichi`, key: `aichi-nagoyacastle`, language: `ja`, name: `名古屋城`, description: `日本の城のひとつ。愛知県名古屋市にある。「名城（めいじょう）」、「金鯱城（きんこじょう、きんしゃちじょう）」、「金城（きんじょう）」の異名を持つ。日本100名城に選定されており、国の特別史跡に指定されている。` },
    { type: `Heads`, prefecture: `Aichi`, key: `aichi-tenmusu`, language: `ja`, name: `天むす`, description: `海老の天ぷらを具にしたおにぎり。名古屋めしの一つとして知られる。` },
    {
...
県庁所在地における快晴日数の多さや降水量1ミリ未満の日数が全国最多であることから、1989年から「晴れの国 おかやま」を県のキャッチフレーズとしている。`},
    { type: `Heads`, prefecture: `Okayama`, key: `okayama-denim01`, language: `ja`, name: `デニム1`, description: `④機能性ジーンズの開発とブランドの多様性: 岡山デニムは、ジャガードやシルク、レーヨンを使用したもの、ストレッチデニム、温感やクール体感などの機能性を持ったデニムなど、デニムの可能性を追求し続けています。さらに、多くのブランドやメーカーが存在し、それぞれが独自の特色やデザインを持つ製品を提供しています。` },
    { type: `Heads`, prefecture: `Okayama`, key: `okayama-denim02`, language: `ja`, name: `デニム2`, description: `⑤地域での完結と品質へのこだわり: 岡山デニムの製造に関するほとんどすべての工程が岡山地域内で完結できるという強みがあります。これにより、高品質で安定した製品づくりが可能になっています。生産者たちは、素材選びから製造工程まで、細部にわたって品質を追求しています。` },
    { type: `Heads`, prefecture: `Okayama`, key: `okayama-denim03`, language: `ja`, name: `デニム3`, description: `⑥長い歴史と職人の技術: 岡山デニムの発展は、数百年の歴史の中での職人の技術の継承と創意工夫や努力の結果であり、その結果として現在の高い評価を得ています。` },
    {
...
１度懐いた人のことを忘れない犬は、人間と一緒に共存しやすい動物ともいえるでしょう。`},
    { type: `Heads`, prefecture: `Okayama`, key: `okayama-horseshoe-crab`, language: `ja`, name: `カブトガニ`, description: `節足動物。ドーム状の体に剣のような尾を持つ。背面全体が広く背甲で覆われ、脚などの付属肢はすべてその下に隠れている。名前はこの背甲に由来する。甲殻類であるカニではない。` },
    { type: `Heads`, prefecture: `Okayama`, key: `okayama-momotaro`, language: `ja`, name: `桃太郎`, description: `日本のおとぎ話の一つ。桃の実から生まれた男子「桃太郎」が、お爺さんお婆さんから黍団子（きびだんご）をもらって、イヌ、サル、キジを家来にし、鬼ヶ島まで鬼を退治しに行く物語。` },
    {
...
頭の良い猿だからこそ、桃太郎の仲間に選ばれたのかもしれませんね。`},
    { type: `Heads`, prefecture: `Okayama`, key: `okayama-peach`, language: `ja`, name: `桃`, description: `中国原産。食用・観賞用として世界各地で品種改良されて栽培される。春には五弁または多重弁の花を咲かせ、夏には水分が多く甘い球形の果実を実らせる。中国では邪鬼を払う力があるとされた。` },
    {
...
桃太郎の仲間の一員としてキジは外せないともいえるでしょう。`},
    { type: `Heads`, prefecture: `Hiroshima`, key: `head-34-hiroshima`, language: `ja`, name: `広島県`, description: `臨海部を中心に自動車産業、製鉄、造船などの工業が発展（瀬戸内海工業地域）している。県庁所在地の広島市は政令指定都市であり中国・四国地方最大の都市である。一方で海・山の豊富な自然にも恵まれ、農業・漁業も盛んである。このことから産業分布が日本平均に近く、県民所得も中位にあり「日本国の縮図」とも呼ばれることがある。` },
    {
...
小豆をなるべく皮を破らないように裏ごしなどをせず、豆の形を残したのが「つぶあん」です。'`},
    { type: `Heads`, prefecture: `Hiroshima`, key: `hiroshima-okonomiyaki`, language: `ja`, name: `広島風お好み焼き`, description: `小麦粉の生地を薄くのばし、キャベツや豚肉、焼きそばなどを山盛りにし、薄く焼いた卵などを重ねて蒸し焼きにしたもの。 ソースは濃厚な甘口のものを用いるのが一般的で、好みでマヨネーズを付ける場合も。 鉄板の上から食べる時は「ヘラ」で食べる。` },
    {
...
あんこうは、ほとんど捨てるところのない魚で、「身・皮・肝・胃・エラ・卵巣・トモ（ヒレ）」をあんこうの七つ道具と呼びます。部位によって違う味と食感が楽しめ、淡白でコラーゲンたっぷりなのに低カロリー。特に肝（アンキモ）はビタミンA・ビタミンB12・ビタミンD・DHA・Epaなど豊富な栄養を含んでおり、見た目と食感から『海のフォアグラ』ともいわれています。`},
    { type: `Heads`, prefecture: `Yamaguchi`, key: `yamaguchi-footballfish`, language: `ja`, name: `チョウチンアンコウ`, description: `丸みを帯びた体型と、餌を誘うために用いられる頭部の誘引突起（イリシウム）を特徴とし、深海魚として比較的よく知られた存在である。` },
    { type: `Heads`, prefecture: `Yamaguchi`, key: `yamaguchi-fuku`, language: `ja`, name: `ふく`, description: `下関市は、ふくの取扱量日本一で、市内には全国でも珍しいふくに特化した卸売市場があり、また、多くのふく加工業者がいることから、ふくは下関の代名詞となっています。さらに、市内のあちこちには、ふくの絵が描かれたマンホール蓋やモニュメントがあるなど、ふくを身近に感じられる街となっています。` },
    {
...
熱した瓦の上に茶そばと具を乗せて、温かいめんつゆで食べる料理である。具は錦糸卵と細切れの牛肉が一般的。薬味として具の上に刻み小ねぎ、のり、スライスしたレモン、もみじおろしが載せられることが多い。`},
    { type: `Heads`, prefecture: `Yamaguchi`, key: `yamaguchi-shoin`, language: `ja`, name: `吉田松陰`, description: `江戸時代後期の日本の武士（長州藩士）、思想家、教育者。明治維新の精神的指導者・理論者。「松下村塾」で明治維新で活躍した志士に大きな影響を与えた。` },
    {
...
江戸時代より約400年の伝統がある阿波踊りなどの文化を有する。`},
    { type: `Heads`, prefecture: `Tokushima`, key: `tokushima-awa-odori01`, language: `ja`, name: `阿波踊り`, description: `阿波国（現・徳島県）を発祥とする盆踊り。高知のよさこい祭りと愛媛の新居浜太鼓祭りと並ぶ四国三大祭りであり、日本三大盆踊りの一つとしても知られる。` },
    {
...
鳴門の渦潮に代表される激しい潮流のなかで育つため、通常のワカメよりも歯ごたえがあり、鮮やかな緑色なのが特徴である。徳島県を代表する名産品の1つ。`},
    { type: `Heads`, prefecture: `Tokushima`, key: `tokusima-whirlpools`, language: `ja`, name: `鳴門の渦潮`, description: `徳島県鳴門市と兵庫県南あわじ市の間の鳴門海峡で発生する渦潮である。大潮の際には渦の直径は最大で30メートルに達するといわれることもあり、渦の大きさは世界最大級といわれる。` },
    {
...
温暖で少雨、夏と冬の温度差が小さく、水はけがよい環境は松の育成に適している。`},
    { type: `Heads`, prefecture: `Ehime`, key: `ehime-iyokan`, language: `ja`, name: `伊予柑`, description: `日本の在来種の柑橘類であり、タンゴールの1種。甘酸っぱくジューシー。果皮は濃いオレンジ色で厚いが、手で剝くことができる。` },
    { type: `Heads`, prefecture: `Ehime`, key: `ehime-jakoten`, language: `ja`, name: `じゃこ天`, description: `主に南予地方の海岸部で作られる魚肉練り製品。地魚などを骨や皮ごとすり身にし、油で揚げてある。揚げたてをそのまま食べるほか、炙って醤油を垂らしても絶品。` },
    { type: `Heads`, prefecture: `Ehime`, key: `ehime-mandarin-orange`, language: `ja`, name: `カラマンダリン`, description: `春に旬を迎えるみかんの仲間。みかんと同じように皮をむいてそのまま食べられる。甘味が強くジューシーで、ジュースやスイーツ、ドライフルーツなど、さまざまな食べ方を楽しめる。` },
    {
...
令制国では土佐国に当たり、県庁所在地の高知市の大半は土佐国の土佐郡に属していた。日本最後の清流といわれる四万十川など四国山地に源を発する清流が多く流れる。`},
    { type: `Heads`, prefecture: `Kochi`, key: `kochi-bonito`, language: `ja`, name: `カツオのたたき`, description: `鰹のタタキは刺身の一種で、高知県発のカツオを用いた料理。鰹を節に切り、表面のみをあぶったのち冷やして切り、薬味とタレをかけて食べるもので、別名「土佐造り」とも言う。` },
    { type: `Heads`, prefecture: `Fukuoka`, key: `fukuoka-mojiko`, language: `ja`, name: `門司港`, description: `北九州市門司区の門司港駅を中心とした地域。観光地としても有名で、海沿いの倉庫群や歴史的建造物など、古い港町の雰囲気を感じることができる地区である。` },
    { type: `Heads`, prefecture: `Fukuoka`, key: `fukuoka-tenmangu`, language: `ja`, name: `太宰府天満宮`, description: `福岡県太宰府市にある神社。菅原道真を祭神として祀る天満宮の一つ。` },
    { type: `Heads`, prefecture: `Fukuoka`, key: `head-40-fukuoka`, language: `ja`, name: `福岡県`, description: `九州地方北部に位置し、九州地方の県では最も人口が多い。県庁所在地の福岡市は、九州地方最大の人口を擁する都市であり、西日本においても大阪市に次ぐ人口を擁する都市である。` },
    { type: `Heads`, prefecture: `Saga`, key: `head-41-saga`, language: `ja`, name: `佐賀県`, description: `日本の九州地方に位置する県。県庁所在地は佐賀市。九州地方の中では最も面積、経済規模が小さい県であり、人口は隣接する福岡県の2割以下であり、福岡市の半分程度に過ぎない。お茶や唐津・伊万里・有田などの古くからの陶磁器の産地として有名。` },
    {
...
`},
    { type: `Heads`, prefecture: `Nagasaki`, key: `head-42-nagasaki`, language: `ja`, name: `長崎県`, description: `日本の九州地方に位置する県。県庁所在地は長崎市。五島列島、壱岐島、対馬など数多くの島嶼を含み、47都道府県中最も島が多いことで知られる。また、多島であるうえにリアス式海岸を多く擁することから海岸線の長さは47都道府県中第2位となっている。` },
    {
...
ちゃんぽんという名称は、中国語の簡単なご飯という意味の「喰飯（シャンポン）」がなまったものが由来という説と、ポルトガル語の混ぜる・混合するという意味の「ちゃんぽん」がなまったものが由来という説など、さまざまある。`},
    { type: `Heads`, prefecture: `Nagasaki`, key: `nagasaki-meganebashi`, language: `ja`, name: `眼鏡橋`, description: `長崎市の中島川に架かる石造二連アーチ橋である。架橋時、琉球王国だった天女橋を除くと、日本初の石造りアーチ橋である。1960年に国の重要文化財に指定された。橋の長さは22メートル、幅3.65メートル、川面までの高さは5.46メートル。2つの半円を描くアーチ形式の石橋で、水面に映しだされた姿が眼鏡のように見えるところからこの名がある。` },
    { type: `Heads`, prefecture: `Nagasaki`, key: `nagasaki-saseboburger`, language: `ja`, name: `佐世保バーガー`, description: `長崎県佐世保市名物の手作りハンバーガーの総称。いわゆるご当地グルメの一種。ひとつの決まったスタイルのハンバーガーを指していうのでなく、佐世保市内の店で提供される「手作りで」「注文に応じて作り始める（作り置きをしない）」ハンバーガーの総称である。` },
    { type: `Heads`, prefecture: `Kumamoto`, key: `head-43-kumamoto`, language: `ja`, name: `熊本県`, description: `九州本島の中央部に位置し、福岡、大分、宮崎、鹿児島の各県と境を接する。海上で有明海を隔て長崎県とも接する。東部の阿蘇地方に日本第2位の阿蘇カルデラを持つ阿蘇山や九州山地の山々が聳え、西部は熊本平野が有明海に、八代平野および芦北地方のリアス式海岸が不知火海に面する。その間に宇土半島が突き出し天草諸島に続いている。中心都市である熊本市は、市域の70万人超の人口を支える水道水が全て地下水でまかなわれている世界でも稀有な都市である。` },
    { type: `Heads`, prefecture: `Kumamoto`, key: `kumamoto-karashirenkon`, language: `ja`, name: `辛子蓮根`, description: `蓮根の穴に辛子味噌を詰め込み、黄色い衣を付けて油で揚げた熊本県の郷土料理である。` },
    { type: `Heads`, prefecture: `Kumamoto`, key: `kumamoto-kumamotocastle`, language: `ja`, name: `熊本城`, description: `現在の熊本県熊本市中央区に築かれた安土桃山時代から江戸時代の日本の城。別名「銀杏城（ぎんなんじょう）」。` },
    {
...
全国的に知名度が高い別府温泉や由布院温泉をはじめとする多くの温泉を有し、源泉数、湧出量ともに日本一であり 、「日本一のおんせん県おおいた」をキャッチフレーズに温泉をアピールしている。`},
    { type: `Heads`, prefecture: `Oita`, key: `oita-beppujigoku`, language: `ja`, name: `別府地獄めぐり`, description: `大分県別府市の別府温泉に多数存在する様々な奇観を呈する自然湧出の源泉「地獄」を、定期観光バスなどで周遊する定番の観光コースである。また、これらの地獄の総称としても使われる。` },
    { type: `Heads`, prefecture: `Oita`, key: `oita-usajingu`, language: `ja`, name: `宇佐神宮`, description: `宇佐神宮（うさじんぐう）は、大分県宇佐市にある神社。全国に約44,000社ある八幡宮の総本社である。日本三大八幡宮の一つ。通称として宇佐八幡とも呼ばれる。` },
    {
...
ビーチや海辺のドライブで知られています。海水浴で人気がある青島海水浴場は、弥生橋によって小さな青島と結ばれており、青島を取り巻く波状の岩は「鬼の洗濯板」と呼ばれています。太平洋岸の有名なサーフスポットには、日向、木崎浜、白浜などがあります。`},
    { type: `Heads`, prefecture: `Miyazaki`, key: `miyazaki-aoshima`, language: `ja`, name: `青島海岸`, description: `宮崎を代表する海水浴場のひとつ「青島海水浴場」を含む海岸で、弥生橋により青島とつながっています。近くには、観光地としても有名な青島神社などもあり、宿泊施設も多い。海水浴場百選にも選ばれている。` },
    { type: `Heads`, prefecture: `Miyazaki`, key: `miyazaki-chickennanban`, language: `ja`, name: `チキン南蛮`, description: `小麦粉と溶き卵を絡めた鶏肉を油で揚げ、甘酢に浸した宮崎県延岡市発祥の日本の鶏肉料理。タルタルソースを掛けて提供されることも多い。` },
    {
...
日本では数少ない南の島であるため、日本屈指のリゾート地である。`},
    { type: `Heads`, prefecture: `Okinawa`, key: `okinawa-goya-chanpuru`, language: `ja`, name: `ゴーヤチャンプル`, description: `チャンプルーとは沖縄方言で「混ぜこぜにしたもの」というような意味であり、野菜や豆腐に限らず、さまざまな材料を一緒にして炒め合わせる。ゴーヤー（ニガウリ）を使うときは「ゴーヤーチャンプルー」、マーミナー（もやし）を使うときは「マーミナーチャンプルー」と、使う食材の名前をつける。` },
    { type: `Heads`, prefecture: `Okinawa`, key: `okinawa-shuricastle`, language: `ja`, name: `首里城`, description: `現在の沖縄県那覇市にあり、かつて海外貿易の拠点だった那覇港を見下ろす丘陵地にあったグスク（御城）の城趾である。戦前の柱や壁は灰色や褐色であったが、第二次世界大戦中に消失した。1992年に柱・壁・瓦も朱色とするデザインで再建し、瓦についても1945年の消失以前の首里城建物は灰色だけ、または赤も灰色瓦の中に混在していたが赤瓦のみで再建された。しかし、2019年10月31日に首里城正殿など主要7棟が延長コード由来の火災で消失した。現在は「首里城公園」として都市公園になっている。2019年の首里城の焼失は、1453年、1660年、1709年、1945年に次ぐ歴史上5度目となった。` },
    { type: `Heads`, prefecture: `Okinawa`, key: `okinawa-siisa`, language: `ja`, name: `シーサー`, description: `沖縄県などでみられる伝説の獣像。魔除けの意味を持ち、屋根の上に設置されることが多いとされている。` },

    { type: `Accessories`, prefecture: `Hokkaido`, key: `hokkaido-crab`, language: `en`, name: `crab`, description: `Hokkaido, a treasure trove of seafood, lands a wide variety of crabs. There are a wide variety of crabs in Hokkaido, with different times of year, seasons, and flavors when they are caught.` },
    {
...
It was introduced to Japan from Europe during the Meiji period (1868-1912), and cultivation in greenhouses began later.`},
    { type: `Accessories`, prefecture: `Hokkaido`, key: `hokkaido-sheep`, language: `en`, name: `Sheep`, description: `Sheep are a cetacean even-toed ungulates in the subfamily Cetacea of the bovine goat family. They have horns and are domesticated primarily for their wool.` },
    { type: `Accessories`, prefecture: `Aomori`, key: `aomori-jade`, language: `en`, name: `Jade`, description: `Jade is one of the deep green translucent gemstones. It has long been a popular gemstone in the Orient and Latin America, and was prized even more than gold.` },
    { type: `Accessories`, prefecture: `Aomori`, key: `aomori-squid`, language: `en`, name: `Squid`, description: `Hachinohe Port in Aomori Prefecture is consistently ranked among the top 10 ports in Japan in terms of landings. Especially for squid, the port has long boasted of having the largest squid landings in Japan. The texture of the squid is the best.` },
...
`, description: `The Oshu Fujiwara clan was a powerful branch of the Fujiwara no Hokke clan that held sway over the Ou region (present-day Tohoku region), including Dewa, centering on Mutsu (later Rikuchu) Hiraizumi, from 1087 after the Mae-nen and Go-nen battles to 1189, when the clan was destroyed by Minamoto no Yoritomo. `
    ...
    { type: `Accessories`, prefecture: `Miyagi`, key: `miyagi-beeftongue`, language: `en`, name: `Ox tongue`, description: `Miyagi Prefecture consumes the largest amount of beef tongue in Japan! A whopping 5,000 tons of beef tongue is consumed annually. Sendai beef tongue is the soul food of Sendai.` },
    {
...
`},
    { type: `Accessories`, prefecture: `Miyagi`, key: `miyagi-zunda`, language: `en`, name: `Zunda mochi`, description: `Zunda Mochi is a local sweet mainly in Miyagi Prefecture, using mashed edamame (soybeans) as the filling.` },
    {
...
Translated with www.DeepL.com/Translator (free version)`},
    { type: `Accessories`, prefecture: `Akita`, key: `akita-hatahata`, language: `en`, name: `Sailfin sandfish`, description: `The 'Hatahata' in Akita, Japan, is a particularly famous type of fish. Hatahata belongs to the salmon family and inhabits the Sea of Japan. In Akita Prefecture, Hatahata is known for being especially abundant during the winter season and is cherished as a winter delicacy.` },
    { type: `Accessories`, prefecture: `Akita`, key: `akita-raspberry`, language: `en`, name: `Raspberry`, description: `The reason raspberries are famous in Akita is due to the region's climate and soil conditions being ideal for raspberry cultivation. Akita experiences cold winters and relatively cool summers, which are conducive to the growth of raspberries. Additionally, the soil in Akita is acidic, making it suitable for raspberry cultivation, which has led to a thriving raspberry industry. Akita's raspberries are known for their deliciousness and are processed into jams and desserts enjoyed by tourists. As a result, Akita is recognized as a prominent raspberry-producing region.` },
    { type: `Accessories`, prefecture: `Yamagata`, key: `yamagata-cherry`, language: `en`, name: `cherry`, description: `Yamagata Prefecture ranks first in the nation in the production of cherries, and is the representative fruit of Yamagata Prefecture, accounting for about 75% of the nation's total production. It is said that cherries are grown in large numbers in Yamagata Prefecture because of the prefecture's climate, which is suitable for growing cherries, with hot summers, little rain during the rainy season, and no strong winds.` },
    { type: `Accessories`, prefecture: `Yamagata`, key: `yamagata-lafrance`, language: `en`, name: `La France, Queen of Yamagata`, description: `Yamagata Prefecture is the largest producer of pear in Japan, accounting for more than 60% of the nation's pear production (as of 2020). In particular, the 'La France' variety of pear is known as the 'Queen of Fruits' for its dense pulp, high juice content, distinctive aroma, and delicious taste.` },
    {
...
Its history dates back to the late Edo period.`},
    { type: `Accessories`, prefecture: `Fukushima`, key: `fukushima-akabeko`, language: `en`, name: `Akabeko`, description: `Akabeko is a papier-mache doll resembling a red cow. It is a local toy of the Aizu region, and has been used to ward off evil spirits in children.` },
    {
...
Lake Inawashiro spans two cities and one town, 'Aizu Wakamatsu City, Koriyama City, and Inawashiro Town.`},
    { type: `Accessories`, prefecture: `Fukushima`, key: `fukushima-train`, language: `en`, name: `Iizaka train`, description: `The Iizaka Line is a railroad line operated by Fukushima Kotsu, running from Fukushima Station to Iizaka Onsen Station in Fukushima City, Fukushima Prefecture. It is nicknamed 'Iizaka Train' or 'Iiden'.` },
    { type: `Accessories`, prefecture: `Ibaraki`, key: `ibaraki-bellpepper`, language: `en`, name: `bellpepper`, description: `Ibaraki Prefecture has the largest shipment of green peppers in Japan. Kamisu City, located between the Pacific Ocean and the Tone River, is a major bell pepper producer. Kamisu City, located between the Pacific Ocean and the Tone River, is a major bell pepper production area, blessed with a mild climate and well-drained soil in a sand dune area.` },
    {
...
It is characterized by the use of small-grain soybeans, which are the mainstream today.`},
    { type: `Accessories`, prefecture: `Ibaraki`, key: `ibaraki-rokkakudo`, language: `en`, name: `hexagonal building`, description: `Rokkakudo is a hexagonal building located in Kitaibaraki City, Ibaraki Prefecture. It stands on the scenic Itsuura Coast, also known as 'Kanto's Matsushima,' and offers one of the most outstanding views of the area.` },
    { type: `Accessories`, prefecture: `Tochigi`, key: `tochigi-gyoza`, language: `en`, name: `chinese dumpling`, description: `Utsunomiya City is famous for its gyoza (dumplings). It is said that the reason for Utsunomiya citizens' love of gyoza is that they eat them for their stamina to cope with the inland climate with cold winters and hot summers.` },
    {
...
It does not contain lemon juice and is labeled as no juice.`},
    { type: `Accessories`, prefecture: `Tochigi`, key: `tochigi-shimotsukare`, language: `en`, name: `Shimotsukare`, description: `It is one of the representative local dishes of Tochigi Prefecture. It is a dish filled with the wisdom of our ancestors, using leftover items such as the heads of salted salmon eaten at New Year's and soybeans left over from roasted beans on Setsubun.` },
    { type: `Accessories`, prefecture: `Gunma`, key: `gunma-akagiyama`, language: `en`, name: `Mt. Akagi`, description: `Akagi is a mountain located in the northern part of the Kanto region, roughly in the center of Gunma Prefecture.` },
    { type: `Accessories`, prefecture: `Gunma`, key: `gunma-tomiokasilkmill`, language: `en`, name: `Tomioka Silk Mill`, description: `Tomioka Silk Mill was Japan's first full-scale mechanical silk mill, established in Tomioka City, Gunma Prefecture. The entire site is designated as a national historic site, and the early buildings are designated as national treasures and important cultural properties.` },
    {
...
As of 2020, it is the second tallest structure in Japan after the Tokyo Sky Tree.'`},
    { type: `Accessories`, prefecture: `Tokyo`, key: `tokyo-yamanote`, language: `en`, name: `Yamanote Line`, description: `The Yamanote Line operates in a loop in the center of Tokyo, the capital of Japan, and connects at many stations to radial lines of JR East and private railway companies extending from the city center to various directions, as well as to subway lines running through the city center.` },
    {
...
It is designated as one of Toyama Prefecture's 'Sana (Fish) of Toyama Prefecture' along with yellowtail and firefly squid.`},
    { type: `Accessories`, prefecture: `Toyama`, key: `toyama-tateyama`, language: `en`, name: `Tateyama`, description: `Tateyama is a representative mountain of Japan located in the Chubu-Sangaku National Park in the northern part of the Hida Mountains (Northern Alps) in Toyama Prefecture, Japan. It is known as the mountain name of the Tateyama faith.` },
    {
...
Kaga Gosai is composed of five colors: rouge, indigo, ochre, grass, and ancient purple, and is mainly used in Kaga Yuzen.`},
    { type: `Accessories`, prefecture: `Ishikawa`, key: `ishikawa-oyster`, language: `en`, name: `Noto oysters`, description: `In Ishikawa Prefecture, Noto is famous for oysters. Noto is a peninsula jutting out into the Sea of Japan. The rough, splashing waters of the Sea of Japan side are called Outer Ura, while the relatively calm Anamizu Bay and Nanao Bay side are called Uchiura, even in winter. The calm waters of Anamizu Bay and Nanao Bay are rich in plankton, which feeds oysters, and oyster cultivation is very active there.` },
    { type: `Accessories`, prefecture: `Fukui`, key: `fukui-echizen-crab`, language: `en`, name: `Echizen crab`, description: `Echizen crab' refers to male snow crabs, and only those caught off the coast of Fukui Prefecture. The Echizen crab fishing season is open from November 6 to March 20, which is about 5 months.` },
    { type: `Accessories`, prefecture: `Fukui`, key: `fukui-heshiko`, language: `en`, name: `Heshiko`, description: `Heshikoshi is a local dish of salted and pickled bluefish. It is a traditional dish of the Wakasa region (southern Fukui Prefecture) and the Tango Peninsula of Kyoto Prefecture, and is valued as a preserved food for the winter.` },
    { type: `Accessories`, prefecture: `Fukui`, key: `fukui-yokan`, language: `en`, name: `Mizu-yokan`, description: `Mizuyokan is one of the most popular winter foods in Fukui Prefecture. Nationally, it is known as a cool snack eaten in summer, but in Fukui Prefecture, it is commonly eaten in a kotatsu (a Japanese low table over a kotatsu) during the cold, snowy season. This food culture is unique to the people of Fukui Prefecture.` },
    { type: `Accessories`, prefecture: `Yamanashi`, key: `yamanashi-fuji`, language: `en`, name: `Mt.Fuji`, description: `Fuji, the tallest mountain in Japan, is 3,776 meters high, and is so popular among the locals that car license plates with the number 3,776 are drawn by lot.` },
    {
...
Yamanashi Prefecture, with its well-drained fan-shaped terrain, long hours of sunlight, and temperature differences between day and night, is the perfect growing region for grapes.`},
    { type: `Accessories`, prefecture: `Nagano`, key: `nagano-kappa`, language: `en`, name: `Kappa`, description: `Kappa are Japanese water monsters. They are also called water deities, or their dependents, or their temporary forms. Along with ogres and tengu, kappa are considered one of the most famous of all Japanese yokai.` },
    { type: `Accessories`, prefecture: `Nagano`, key: `nagano-oyaki`, language: `en`, name: `Oyaki`, description: `Local cuisine of Nagano Prefecture. Each region has its own characteristics, and ingredients such as Nozawana are wrapped in a wrapper made of flour or buckwheat flour dissolved in water. Oyaki can be prepared by grilling, steaming, or steaming and then grilling.` },
    ...
    { type: `Accessories`, prefecture: `Gifu`, key: `gifu-gohei-mochi`, language: `en`, name: `Gohei mochi`, description: `Gohei-mochi is a local dish of Gifu Prefecture. It is made of half-polished Uruchimai rice with a sauce and grilled on a skewer.` },
    {
...
In the Hida dialect, the word for baby is 'bobo' and 'sarubobo' means 'monkey baby. In recent years, Sarubobo can be found at many tourist attractions in the Hida region as souvenirs.`},
    ...
    { type: `Accessories`, prefecture: `Shizuoka`, key: `shizuoka-fuji`, language: `en`, name: `Mt.Fuji`, description: `Fuji, the tallest mountain in Japan, is 3,776 meters high, and is so popular among the locals that car license plates with the number 3,776 are drawn by lot.` },
    { type: `Accessories`, prefecture: `Aichi`, key: `aichi-misodengaku`, language: `en`, name: `Miso dengaku`, description: `Miso dengaku is a dish in which tofu, taro, eggplant, konnyaku, etc. are skewered, grilled, and coated with miso paste mixed with sugar and mirin and flavored with yuzu or kinome.` },
    { type: `Accessories`, prefecture: `Aichi`, key: `aichi-oguratoast`, language: `en`, name: `Ogura Toast`, description: `Ogura toast is a type of light meal served at coffee shops in Aichi Prefecture. Thickly sliced bread is toasted, then spread with margarine or butter and topped with Ogura-an (sweet bean paste).` },
    {
...
Momotaro, a hero deeply rooted in Japanese folklore, emerges from a peach to vanquish demons with the help of his companions. This tale is intricately tied to the ancient traditions of the Okayama region, specifically the Kibi area, believed to have been the actual setting for the legend. The ancient myths of Kibi remarkably align with Momotaro's adventures, and the statue of Momotaro in front of Okayama Station stands as a testament to this connection. Yet, the legend of Momotaro resonates throughout Japan, with variations of the story told in different regions. Parallels have been drawn between Momotaro's tale and ancient stories from other countries, positioning him as an international hero. The bond between Okayama and Momotaro is further strengthened by the region's famed kibi dango and its iconic peaches. Merging ancient history with folklore, Okayama's Momotaro continues to captivate our hearts today.`},
    { type: `Accessories`, prefecture: `Okayama`, key: `okayama-peach02`, language: `en`, name: `white peach`, description: `Okayama's white peaches, harvested in the mild climate of the Seto Inland Sea, are famous throughout Japan for their sweet, smooth taste, noble aroma, and elegant appearance.` },
    { type: `Accessories`, prefecture: `Okayama`, key: `okayama-retainer`, language: `en`, name: `attendant`, description: `Please give me one of the ”kibidango' you have on your waist.` },
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-battleship`, language: `en`, name: `Yamato battleship`, description: `The Yamato was the first of the Yamato class battleships built by the Imperial Japanese Navy, and together with the Musashi, the second, it was the largest and only IJN battleship ever built with a 46 cm gun. When it was first built, it was the largest battleship in the world.` },
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-lemon`, language: `en`, name: `Hiroshima lemon`, description: `Hiroshima lemons are produced in Hiroshima Prefecture. They are grown with reduced or no pesticides, and no preservatives or wax are used, so they can be safely eaten with their peels.` },
    {
...
Hiroshima oysters are characterized by their plump meat and rich flavor.`},
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-rice-scoop`, language: `en`, name: `rice-scoop`, description: `During the Russo-Japanese War, Miyajima Island, located in Hiroshima Bay, was one of the places where soldiers went to war. Before going to war, soldiers would visit Itsukushima Shrine on Miyajima to pray for their safe return and dedicate a rice-scoop as a good luck charm.` },
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-shrine`, language: `en`, name: `Itsukushima shrine`, description: `Itsukushima Shrine is located on Itsukushima (Miyajima) Island in Hatsukaichi City, Hiroshima Prefecture. It is the head shrine of approximately 500 Itsukushima shrines throughout Japan. It was registered as a UNESCO World Heritage Site in 1996 as Itsukushima Shrine.` },
    { type: `Accessories`, prefecture: `Hiroshima`, key: `hiroshima-wani`, language: `en`, name: `Crocodile dishes`, description: `Crocodile cuisine is a local dish eaten in the Bihoku region of Hiroshima Prefecture, including Miyoshi City and Shobara City.` },
    {
...
`, description: `Motonosumi Inari Shrine is located in Aburayatsukou, Nagato City, Yamaguchi Prefecture.`
    ...
    { type: `Accessories`, prefecture: `Yamaguchi`, key: `yamaguchi-white -snake`, language: `en`, name: `Iwakuni's White Snake`, description: `The Iwakuni's White Snake is a white snake that lives in Iwakuni City, Yamaguchi Prefecture. This white snake's whitening is passed on to offspring generations through heredity. It is a natural monument designated by the Japanese government.` },
    {
...
It is edible when the shell plate, also called the 'claw,' is held in place and the handle, also called the 'skin,' is removed and the contents extracted. It has a rich flavor. It is often eaten in Uwajima City, Ehime Prefecture, boiled in salted water or served in miso soup.`},
    { type: `Accessories`, prefecture: `Kochi`, key: `kochi-seared-bonito`, language: `en`, name: `Seared bonito`, description: `Bonito tataki is a type of sashimi, a dish using bonito that originated in Kochi Prefecture. It is also known as 'Tosa-zukuri.' It is made by cutting bonito into knots, frying only the surface, cooling and cutting it, and serving it with condiments and sauce.` },
...
In Oita Prefecture, grain cultivation has been practiced in the fields since ancient times, and a flour-based food culture has developed. In addition to yaseuma, flour-based dishes have spread throughout the prefecture.`},
    ...
    { type: `Accessories`, prefecture: `Kagoshima`, key: `kagoshima-senganen`, language: `en`, name: `sengan-en`, description: `Sengan-en Garden is the villa and feudal lord's garden of Shimazu, the feudal lord of Satsuma, located in Kagoshima City, Kagoshima Prefecture. It is also known as Iso-teien. It was built as a villa on Iso by Mitsuhisa Shimazu, the 19th head of the Shimazu clan. The garden is designated as a national place of scenic beauty with Sakurajima across Kinko Bay in the background.` },
    { type: `Accessories`, prefecture: `Kagoshima`, key: `kagoshima-shochu`, language: `en`, name: `syochu liqueur`, description: `Activities are also available, and hiking and trekking can be enjoyed. Playing in the waterfall basin and strolling in the valley are also attractive. Takachiho Shrine is also located nearby and is known as a historical sanctuary associated with ancient myths and legends.` },
    { type: `Accessories`, prefecture: `Okinawa`, key: `okinawa-fish`, language: `en`, name: `tropical fish`, description: `The beautiful waters of Okinawa are home to spectacular coral reefs with colorful fish. The area is known as a paradise for scuba diving and snorkeling, and the beauty of the fish is truly spectacular.` },
    { type: `Accessories`, prefecture: `Okinawa`, key: `okinawa-satokibi`, language: `en`, name: `Sugarcane`, description: `Sugarcane is one of the ingredients of sugar. Sugarcane is a crop that is very resistant to strong winds and water shortages. For this reason, sugarcane is an indispensable core crop in Okinawa Prefecture, which has a harsh natural environment with typhoons and droughts, and about 70% of farmers grow sugarcane.` },
    {
...
In Okinawa, it is usually eaten on top of tofu. It is a delicious snack with a unique salty taste that is slowly marinated in mineral-rich natural salt!`},
    { type: `Heads`, prefecture: `Hokkaido`, key: `head-01-hokkaido`, language: `en`, name: `Hokkaido`, description: `Hokkaido is a province located in the Hokkaido region of Japan. The capital of Hokkaido is Sapporo, and it is the only 'province' among the 47 prefectures in Japan.` },
    { type: `Heads`, prefecture: `Hokkaido`, key: `hokkaido-goryokaku`, language: `en`, name: `Goryokaku`, description: `Goryokaku was a ridge-top fortification built by the Edo shogunate at the end of the Edo period on the outskirts of Hakodate in the Ezo region (present-day Hakodate City, Hokkaido).` },
    {
...
It is the oldest clock tower in Japan, with a triangular roof and a large clock on top.'`},
    ...
    { type: `Heads`, prefecture: `Aomori`, key: `aomori-dogu`, language: `en`, name: `clay figure`, description: `Dogu refers to clay figures made in the Japanese archipelago around the Jomon period.` },
    {
...
It is the second largest prefecture in Japan in terms of area after Hokkaido. Of the prefecture's population of approximately 1.2 million, more than 1 million (more than 80%) are concentrated in the inland Kitakami Basin, while the coastal area has few flat areas and is dotted with small cities.`},
    { type: `Heads`, prefecture: `Iwate`, key: `iwate-moriokamen`, language: `en`, name: `Morioka three major noodles`, description: `Morioka's three major noodles are Morioka cold noodles, Morioka jaja-men, and wanko-soba. ` },
    { type: `Heads`, prefecture: `Iwate`, key: `iwate-nanbutekki`, language: `en`, name: `Nambu ironware`, description: `Nambu ironware is made by members of the Iwate Prefecture Nambu Ironware Cooperative Union, with an estimated 730 workers at 74 establishments and an annual production value of approximately 9.2 billion yen.` },
    {
...
Rice cultivation is flourishing in the plains of the prefecture, and Sasanishiki and Hitomebore are the main products of the prefecture.`},
    { type: `Heads`, prefecture: `Miyagi`, key: `miyagi-datemasamune`, language: `en`, name: `Date Masamune`, description: `Date Masamune was a general and warlord of Yamagata and Miyagi prefectures. He was the 17th head of the Date clan. As a feudal lord in modern times, he was the first lord of the Sendai clan.` },
    { type: `Heads`, prefecture: `Miyagi`, key: `miyagi-hoya`, language: `en`, name: `Hoya`, description: `Miyagi Prefecture ranks first in Japan in the production of ascidians, accounting for about 80% of the national total. The majority of hoya are farm-raised, and hoya farming is said to have begun in Miyagi Prefecture during the Meiji period (1868-1912).` },
    ...
    { type: `Heads`, prefecture: `Akita`, key: `akita-namahage`, language: `en`, name: `Namahage`, description: `In Japan, particularly in Akita Prefecture, 'Namahage' is a traditional festival or event where individuals wear demon-like masks and play the role of characters delivering stern lessons to children.` },
    { type: `Heads`, prefecture: `Akita`, key: `head-05-akita`, language: `en`, name: `Akita`, description: `Akita boasts a rich tapestry of traditional festivals and events, with unique cultural treasures like the 'Kanto Festival' and 'Namahage.' These celebrations not only reflect the local identity but also offer visitors distinctive experiences.` },
    {
...
The Mogami River flows through the center of the prefecture. It is also called 'Mother River' because most of the residents of the prefecture live in the watershed of this river.`},
    { type: `Heads`, prefecture: `Yamagata`, key: `yamagata-hanagasa`, language: `en`, name: `Hanagasa Festival`, description: `Hanagasa Matsuri is a Japanese festival in which people parade through the streets with sedge hats decorated with red flowers, dancing to the tune of “Hanagasa Ondo”.` },
    { type: `Heads`, prefecture: `Yamagata`, key: `yamagata-imoni`, language: `en`, name: `Imoni`, description: `Imoni is one of the local dishes often eaten from autumn to winter, when taro is harvested. It is also cooked outdoors at sports meets or after community events, and is also prepared and eaten at home.` },
...
Kashima City and Kamisu City in the eastern part of the prefecture form the Kashima Coastal Industrial Zone, and industrialization is progressing.`},
    ...
    { type: `Heads`, prefecture: `Ibaraki`, key: `ibaraki-rocket`, language: `en`, name: `Tukuba Space Center`, description: `The Tsukuba Space Center (TKSC) is an independent administrative facility related to the space program owned by the Japan Aerospace Exploration Agency (JAXA), located within the Tsukuba Science City in Tsukuba, Ibaraki Prefecture.` },
    {
...
Nikko National Park is located in the northern part of the prefecture, and the tourist and recreational areas of Nikko and Nasu are well known.`},
    { type: `Heads`, prefecture: `Tochigi`, key: `tochigi-sanzaru`, language: `en`, name: `three monkeys`, description: `The three monkeys are three monkeys with their hands covering their eyes, ears, and mouths, respectively. The image represents the three secrets of wisdom: 'See no evil, hear no evil, speak no evil. It is displayed in the Shinto stables in Nikko City, Tochigi Prefecture.` },
    ...
    { type: `Heads`, prefecture: `Tochigi`, key: `tochigi-toshogu`, language: `en`, name: `Nikko Toshogu`, description: `Nikko Toshogu Shrine is located in Nikko City, Tochigi Prefecture, in the northern part of the Kanto region of Japan. It is the headquarters of all Toshogu shrines in Japan. Together with Kunouzan Toshogu and Ueno Toshogu, it is one of the three major Toshogu shrines in Japan.` },
    {
...
As of 2020, it is the second tallest structure in Japan after the Tokyo Sky Tree.`},
    ...
    { type: `Heads`, prefecture: `Kanagawa`, key: `kanagawa-curry`, language: `en`, name: `Kanazawa curry`, description: `Curry rice with unique characteristics served at curry rice restaurants in Ishikawa Prefecture, mainly in Kanazawa City.` },
    {
...
The prefecture has the fifth highest annual precipitation among prefectures. In winter, precipitation is especially heavy due to the continuous monsoon from the northwest, and mountainous areas are heavy snowfall areas. Snowfall is often accompanied by thunderstorms, and this phenomenon is known as 'yellowtail awakening' because it coincides with the time of year when yellow-tail is caught.`},
    { type: `Heads`, prefecture: `Ishikawa`, key: `ishikawa-curry`, language: `en`, name: `Kanazawa curry`, description: `Curry rice with unique characteristics served at curry rice restaurants in Ishikawa Prefecture, mainly in Kanazawa City.` },
    {
...
The basic style is to cut the broiled eel meat into pieces and place them on rice in a rice box, which is then served in a bowl or other container. Generally, wasabi (Japanese horseradish), chopped nori (dried laver), chopped green onion, and other condiments, soup stock, and tea are served with the eel rice.`},
    { type: `Heads`, prefecture: `Aichi`, key: `aichi-nagoyacastle`, language: `en`, name: `Nagoya Castle`, description: `One of the castles in Japan. It is located in Nagoya City, Aichi Prefecture. It is also known as 'Meijo,' 'Kinshachi-jo,' or 'Kin-jo'. It has been selected as one of the 100 best castles in Japan and is designated as a national special historic site.` },
    { type: `Heads`, prefecture: `Aichi`, key: `aichi-tenmusu`, language: `en`, name: `Tenmusu`, description: `Onigiri with shrimp tempura as a filling. Known as one of Nagoya-meshi.` },
    {
...
Since 1989, the prefecture has used the catchphrase 'sunny country, Okayama' in reference to the large number of sunny days and the number of days with less than one millimeter of precipitation in the prefecture's capital city, which are the highest in Japan.`},
    ...
    { type: `Heads`, prefecture: `Okayama`, key: `okayama-denim02`, language: `en`, name: `denim`, description: `⑤Local Production and Commitment to Quality: A significant advantage of Okayama denim is that almost all stages of its production are completed within the Okayama region. This ensures the creation of high-quality, consistent products. Producers are meticulous, from material selection to the manufacturing process, ensuring the highest quality.` },
    {
...
Anglerfish is a fish with almost nothing to throw away, and its meat, skin, liver, stomach, gills, ovaries, and fins are called the 'seven essentials' of anglerfish. Each part of the fish has a different taste and texture, and is light, full of collagen, and low in calories. In particular, the liver (ankimo) is rich in nutrients such as vitamin A, vitamin B12, vitamin D, DHA, and epa, and is also called the 'foie gras of the sea' for its appearance and texture.  `},
    { type: `Heads`, prefecture: `Yamaguchi`, key: `yamaguchi-footballfish`, language: `en`, name: `footballfish`, description: `It is a relatively well-known deep-sea fish, characterized by its rounded body shape and the attractant process on its head (iridium) used to attract food.` },
    { type: `Heads`, prefecture: `Yamaguchi`, key: `yamaguchi-fuku`, language: `en`, name: `fuku`, description: `Shimonoseki City handles the largest volume of fuku (blowfish) in Japan and has a wholesale market specializing in fuku (blowfish), which is rare in Japan, as well as many blowfish processors. In addition, there are manhole covers and monuments with pictures of fū here and there in the city, making the city a place where people can feel close to fū.` },
    {
...
Because it grows in the violent tidal currents represented by the Naruto whirlpools, it has a chewier texture and a brighter green color than ordinary wakame. It is one of the representative specialty products of Tokushima Prefecture.`},
    { type: `Heads`, prefecture: `Tokushima`, key: `tokusima-whirlpools`, language: `en`, name: `whirlpools of naruto`, description: `The Naruto Straits between Naruto City, Tokushima Prefecture, and Minami-Awaji City, Hyogo Prefecture, are home to the Naruto whirlpools. During high tide, the diameter of the whirlpool is said to be up to 30 meters, making it one of the largest whirlpools in the world.` },
    {
...
The mild climate, low rainfall, small temperature difference between summer and winter, and well-drained environment are suitable for growing pine trees.`},
    { type: `Heads`, prefecture: `Ehime`, key: `ehime-iyokan`, language: `en`, name: `iyokan`, description: `A Japanese native citrus, a type of tangor. Sweet, sour and juicy. The skin is dark orange and thick, but can be peeled by hand.` },
    {
...
The majority of Kochi City, the prefectural capital, belonged to Tosa County in Tosa Province. The Shimanto River, said to be the last clear stream in Japan, and many other clear streams originate in the Shikoku Mountains.`},
    ...
    { type: `Heads`, prefecture: `Fukuoka`, key: `fukuoka-mojiko`, language: `en`, name: `Moji-port`, description: `The area centered around Mojiko Station in Mojikou, Kitakyushu City. Famous as a tourist destination, the district offers the atmosphere of an old port town with its warehouses and historical buildings along the sea.` },
    { type: `Heads`, prefecture: `Fukuoka`, key: `fukuoka-tenmangu`, language: `en`, name: `Dazaifu Tenmangu Shrine`, description: `A shrine located in Saifu, Dazaifu City, Fukuoka Prefecture. It is one of the Tenmangu shrines dedicated to Sugawara no Michizane.` },
    { type: `Heads`, prefecture: `Fukuoka`, key: `head-40-fukuoka`, language: `en`, name: `Fukuoka Prefecture`, description: `Located in the northern part of the Kyushu region, Fukuoka is the most populous prefecture in Kyushu. Fukuoka City, the prefectural capital, has the largest population in the Kyushu region and is the second most populous city in western Japan after Osaka City.` },
...
There are various theories as to the origin of the name 'chanpon,' which is a corruption of the Chinese word 'shanpon,' meaning 'simple rice,' and the Portuguese word 'chanpon,' meaning 'to mix,' or 'to mix.`},
    ...
    { type: `Heads`, prefecture: `Nagasaki`, key: `nagasaki-saseboburger`, language: `en`, name: `Sasebo Burger`, description: `A generic name for handmade hamburgers, a specialty of Sasebo City, Nagasaki Prefecture. It is a kind of local gourmet food. It does not refer to a single style of hamburger, but rather a generic term for hamburgers that are 'handmade' and 'made to order' (not made to order) served at restaurants in Sasebo City.` },
    ...
    { type: `Heads`, prefecture: `Kumamoto`, key: `kumamoto-karashirenkon`, language: `en`, name: `mustard lotus root`, description: `It is a local dish of Kumamoto Prefecture, where lotus root holes are stuffed with spicy miso paste, coated with yellow batter, and deep-fried in oil.` },
    { type: `Heads`, prefecture: `Kumamoto`, key: `kumamoto-kumamotocastle`, language: `en`, name: `Kumamoto Castle`, description: `A Japanese castle from the Azuchi-Momoyama period to the Edo period, built in present-day Chuo Ward, Kumamoto City, Kumamoto Prefecture. Also known as 'Ginnajo (Ginnan Castle).` },
    {
...
It is known for its beaches and seaside drives. Aoshima Beach, popular for swimming, is connected to the smaller Aoshima by Yayoi Bridge, and the wavy rocks surrounding Aoshima are known as the 'devil's washboard. Famous surfing spots on the Pacific coast include Hyuga, Kisakihama, and Shirahama.`},
    { type: `Heads`, prefecture: `Miyazaki`, key: `miyazaki-aoshima`, language: `en`, name: `Aoshima coast`, description: `This beach includes Aoshima Beach, one of Miyazaki's representative beaches, and is connected to Aoshima by Yayoi Bridge. Nearby are Aoshima Shrine, a famous tourist attraction, and many lodging facilities. It has been selected as one of the 100 best beaches.` },
    {
...
As one of the few southern islands in Japan, it is one of the country's most popular resort destinations.`},
    ...
    { type: `Heads`, prefecture: `Okinawa`, key: `okinawa-siisa`, language: `en`, name: `shisa`, description: `Legendary beast statues found in Okinawa and other prefectures. It is believed to ward off evil and is often placed on roofs.` },
];
